...
you can wish for a specific number of random users or paragraphs of lorem ipsum text. Just indicate the desired number of users or paragraphs by entering a number 
between 1-99 to the forms on each page. For the random user generator, you can also indicate if you 
would like to inclue birthday, profile text, email, and phone number with each user in your results. Then just
